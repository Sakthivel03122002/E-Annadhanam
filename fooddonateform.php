...
<head>
    ...
    <title>E-Annadhanam</title>
    <link rel="stylesheet" href="loginstyle.css">
</head>
<body style="    background-color:  rgba(239, 40, 40, 0.63);">
    <div class="container">
        <div class="regformf" >
    <form action="" method="post">
        <p class="logo"> <b style="color: rgb(190, 18, 32); ">E-Annadhanam</b></p>
...
<select id="district" name="district" style="padding:10px;">
  ...
  <option value="kanniyakumari">Kanniyakumari</option>
        ...
        <div class="btn">
            <button type="submit" name="submit"style = "background-color:rgb(190, 18, 32)"> submit</button>
