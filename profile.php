...
<body>
<header>
        <div class="logo"><b style="color: rbg(190,18,32);">E-Annadhanam</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
    ...
    <!-- <section class="cover" >
     ...
     -->
        <div class="profilebox" style="">
            ...
            <p class="headingline" style="text-align: left;font-size:30px; text-decoration: underline 5px;
    text-decoration-color: rgb(190, 18, 32);"> <img src="" alt="" style="width:40px; height:  height: 25px;; padding-right: 10px; position: relative;" >Profile</p>
<!--             
            ...
            <br> -->
              ...
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: rgb(190, 18, 32); color: white;padding: ;padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
